...
if (fs.existsSync(cliPath)) {
  ...
  console.error("Error: Enact binary not found for macOS x64 (Intel).");
  console.error("");
  console.error("The macOS x64 binary was not included in this release.");
  console.error("");
  console.error("Workarounds:");
  console.error("  1. Use Node.js directly: npx @enactprotocol/cli <command>");
  console.error("  2. Wait for a release with macOS x64 binaries");
