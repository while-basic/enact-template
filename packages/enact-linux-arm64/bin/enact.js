...
if (fs.existsSync(cliPath)) {
  ...
  console.error("Error: Enact binary not found for Linux ARM64.");
  console.error("");
  console.error("The Linux ARM64 binary was not included in this release.");
  console.error("");
  console.error("Workarounds:");
  console.error("  1. Use Node.js directly: npx @enactprotocol/cli <command>");
  console.error("  2. Wait for a release with Linux ARM64 binaries");
