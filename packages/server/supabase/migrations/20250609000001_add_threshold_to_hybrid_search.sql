-- Add match_threshold parameter to search_tools_hybrid function
-- This allows users to control the similarity threshold for search results

-- Replace the hybrid search function with threshold parameter
...
COMMENT ON FUNCTION search_tools_hybrid(text, vector, float, float, int, float) IS 'Hybrid search combining text matching and semantic similarity with configurable threshold';
